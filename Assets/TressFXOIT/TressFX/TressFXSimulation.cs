...
namespace TressFX
{
	...
	/// </summary>
	public class TressFXSimulation 
    {
        /// <summary>
		...
		/// </summary>
		public int lengthConstraintIterations = 3;
		...
		public TressFXSimulation(TressFX master, Transform transform)
		{
            // No shader? :-(
            this.simulationShader = (ComputeShader) Resources.Load("Shaders/Simulation");
